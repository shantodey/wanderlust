...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/banner.png')] text-white  flex justify-between flex-col items-center  gap-5 h-150">
      ...
      <div className="bg-white/30 flex flex-wrap justify-between gap-3 w-full items-center px-2">
        <div className="px-3 flex-1 min-w-20">
        ...
        <div className="bg-cyan-500 py-2 px-4 shrink-0">
          <h3>Search</h3>
        </div>
      </div>
    </div>
